            ...
            <div className="d-flex flex-column gap-4 text-start p-3">
              ...
              <div className="contact-data d-flex align-items-center gap-4">
                <img
                  ...
                  loading="lazy"
                ></img>
                <span style={{ fontFamily: "GeneralSans-Regular" }}>
                  <a
                    href="mailto:seenivasan90it@gmail.com"
                    className="text-lg  text-ternary-dark dark:text-ternary-light h5 text-decoration-none"
                  >
